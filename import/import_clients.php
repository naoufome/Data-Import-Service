...
$host = 'localhost';
$db = 'your_database_name'; // <<< IMPORTANT: Change to your database name
$user = 'your_db_user';   // <<< IMPORTANT: Change to your database user
$pass = 'your_db_password';       // <<< IMPORTANT: Change to your database password
$charset = 'utf8mb4';
